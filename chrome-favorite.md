...
## Decohack
> https://www.decohack.com/ （上一次阅读进度：52 期）
...
- [Nano Expansion Accordion Example](https://www.cssscript.com/demo/accordion-nano-expansion/)
- [Nested Accordion Menu Example](https://www.cssscript.com/demo/nested-accordion-menu/#)
- [Tiny Accordion Component Examples](https://www.cssscript.com/demo/tiny-accordion-component/)

- [Pure JS/CSS Accordion Demo](https://www.cssscript.com/demo/simple-plain-accordion-interface-pure-jscss/)

### image

- [Image Compare Viewer Example](https://www.cssscript.com/demo/image-compare-viewer/)
...
- [Animated Skeleton Loader Examples](https://www.cssscript.com/demo/animated-skeleton-loader/)
- [Screen Skeleton Loader In CSS Examples](https://www.cssscript.com/demo/screen-skeleton-loader/)

- [zalog/placeholder-loading: Simple and flexible, css only, content placeholder loading animation. https://zalog.github.io/placeholder-loading/](https://github.com/zalog/placeholder-loading)

- [Pure CSS Skeleton Loading Screen Examples](https://www.cssscript.com/demo/animated-skeleton-loading-screen/)

### menu-nav

- [Mobile-friendly Hamburger Navigation With Submenus Example](https://www.cssscript.com/demo/hamburger-navigation-submenus/)
- [Touch side swipe Demo](https://www.cssscript.com/demo/mobile-friendly-swipe-menu-vanilla-javascript-touch-side-swipe/)

- [Vertical Responsive Menu Demo Page](https://www.cssscript.com/demo/responsive-sidebar-navigation-with-javascript-and-css3/)

### toast

- [Toastify: Toast Message Demo](https://www.cssscript.com/demo/simple-vanilla-javascript-toast-notification-library-toastify/#)
- [Minimal Snackbar UI Example](https://www.cssscript.com/demo/snackbar-ui-component/)

- [Cute Alert Box Examples](https://www.cssscript.com/demo/alert-confirm-toast-cute/)
