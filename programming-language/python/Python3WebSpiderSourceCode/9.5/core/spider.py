...
class Spider():
    ...
    def error(self, request):
        ...
        # 1...MAX_FAILED_TIME-1 => MAX_FAILED_TIME-1 times can be tried
        if request.fail_time < MAX_FAILED_TIME:
            self.queue.add(request)
        else:
            # here should fail through to the whole app
            pass
    ...
    def schedule(self):
        ...
        while not self.queue.empty():
            ...
            # 如果第一次请求成功’那么这时的队列里会新增爬取第一个列表页中l0部电影对应的详情页的请求,和爬取下一页的请求,
            # 即队列中又多了11个新请求
