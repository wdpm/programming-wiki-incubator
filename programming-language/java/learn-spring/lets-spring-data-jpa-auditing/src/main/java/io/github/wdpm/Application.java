...
import io.github.wdpm.repositories.TodoRepository;
...
public class Application {
    ...
    public CommandLineRunner auditingDemo(TodoRepository todoRepository) {
        return args -> {
            ...
            // create new todos
            todoRepository.saveAll(Arrays.asList(new Todo("Buy milk", false), new Todo("Email John", false),
                                                 new Todo("Visit Emma", false), new Todo("Call dad", true),
