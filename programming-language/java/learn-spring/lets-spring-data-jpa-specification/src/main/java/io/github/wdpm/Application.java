...
import io.github.wdpm.repository.MovieRepository;
import io.github.wdpm.repository.spec.MovieSpecification;
import io.github.wdpm.repository.spec.SearchCriteria;
import io.github.wdpm.repository.spec.SearchOperation;
...
public class Application {
    ...
    public CommandLineRunner specificationsDemo(MovieRepository movieRepository) {
        return args -> {
            ...
            System.out.println("// search movies by watch time >= 150 and sort by `title` ASC");
            ...
            System.out.println("// search movies by title <> 'white' and paginate results");
            ...
            System.out.println("// search movies by title endsWith 'ther'");
            MovieSpecification msTitleEnd = new MovieSpecification();
            msTitleEnd.add(new SearchCriteria("title", "ther", SearchOperation.MATCH_END));
            List<Movie> msTitleEndList = movieRepository.findAll(msTitleEnd);
            msTitleEndList.forEach(System.out::println);
            System.out.println("================");
        };
    }
}
