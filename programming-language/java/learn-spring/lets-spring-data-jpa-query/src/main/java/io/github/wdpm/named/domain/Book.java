package io.github.wdpm.named.domain;
 ...
 * <p>Annotation parameters [wrap always] and Array initializers line break after "{"
 */
@Entity
@NamedQueries({
...
public class Book {
    ...
    public String toString() {
        return "Book{" + "id=" + id + ", title='" + title + '\'' + ", isbn='" + isbn + '\'' + ", pages=" + pages + '}';
    }
}
