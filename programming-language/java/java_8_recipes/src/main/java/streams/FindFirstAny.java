...
public class FindFirstAny {
    ...
    public static void main(String[] args) {
        ...
        // findFirst() 返回流中遇到顺序（encounter order）的第一个元素，而不是最快计算出来的元素。
        ...
        // unordered() 不改变流的底层数据顺序，它只是告诉 JVM：“后续操作不必保证顺序”。
        // 但 forEach 在串行流中：仍然按元素在流中的原始位置依次遍历, unordered() 不会让它变得“乱序”
